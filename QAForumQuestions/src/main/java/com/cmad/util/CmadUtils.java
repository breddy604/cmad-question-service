package com.cmad.util;

public class CmadUtils {

    public static final String QUESTION_GET = "com.cmad.vertx.qaforum.question.get";
    ...
    public static final String QUESTION_ALL_LIMIT = "questions.all.limit";
